...
def create_watchdog_observer(function, path, logger):
    ...
    try:
        ...
        logger.warning('Directory watching is enabled, but failed to import watchdog. Please, install watchdog python package.')
