...
class DebugTransform:
    ...
    def transform_chunk(self, tornado_request: httputil.HTTPServerRequest, response: Response) -> Response:
        ...
        return Response(status_code=200, headers=wrap_headers, body=log_document)
