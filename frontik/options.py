...
define('influxdb_connect_timeout_sec', default=0.2, type=float)
define('influxdb_request_timeout_sec', default=0.5, type=float)
define('influxdb_metrics_db', default=None, type=str)
define('influxdb_metrics_rp', default=None, type=str)
define('influxdb_heartbeat_period_sec', default=10, type=str)
