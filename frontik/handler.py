...
class PageHandler(RequestHandler):
    ...
    def get_str_argument(
        self,
        name: str,
        default: str | list[str] | None = _ARG_DEFAULT,
        path_safe: bool = True,
        **kwargs: Any,
    ) -> str | list[str] | None:
        if path_safe:
    ...
    def get_int_argument(
        self,
        name: str,
        default: int | list[int] | None = _ARG_DEFAULT,
        **kwargs: Any,
    ) -> int | list[int] | None:
    ...
    def get_bool_argument(
        self,
        name: str,
        default: bool | list[bool] | None = _ARG_DEFAULT,
        **kwargs: Any,
    ) -> bool | list[bool] | None:
    ...
    def get_float_argument(
        self,
        name: str,
        default: float | list[float] | None = _ARG_DEFAULT,
        **kwargs: Any,
