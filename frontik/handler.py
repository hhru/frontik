...
class PageHandler(RequestHandler):
    ...
    def finish_with_postprocessors(self):
        ...
        task = asyncio.create_task(self._postprocess())
    ...
    def _handle_request_exception(self, e):
        ...
        if isinstance(e, FailFastError):
            ...
            super()._handle_request_exception(e)  # 2
    ...
    def send_error(self, status_code=500, **kwargs):
        ...
        try:
            self.write_error(status_code, **kwargs)  # 4
        except Exception:
    ...
    def write_error(self, status_code=500, **kwargs):
        ...
        if exception is not None:
            self.my_badass_task.set_exception(exception)
        self.set_header('Content-Type', media_types.TEXT_HTML)
        return super().write_error(status_code, **kwargs)  # 5
    ...
    def finish(self, chunk=None):
        ...
        res = super().finish(chunk)
        self.cleanup()
        if not self.my_badass_task.done():
            self.my_badass_task.set_result(None)
        return res
    ...
    async def get_url(self, host, uri, *, name=None, data=None, headers=None, follow_redirects=True, profile=None,
        ...
        return await self._execute_http_client_method(host, uri, client_method, waited)

    async def head_url(self, host, uri, *, name=None, data=None, headers=None, follow_redirects=True, profile=None,
                       connect_timeout=None, request_timeout=None, max_timeout_tries=None,
                       speculative_timeout_pct=None, waited=True, fail_fast=False) -> RequestResult:
    ...
    async def post_url(self, host, uri, *,
                       ...
                       idempotent=False, speculative_timeout_pct=None, waited=True, parse_response=True,
                       parse_on_error=True, fail_fast=False) -> RequestResult:
    ...
    async def put_url(self, host, uri, *, name=None, data='', headers=None, content_type=None, follow_redirects=True,
    ...
    async def delete_url(self, host, uri, *, name=None, data=None, headers=None, content_type=None, profile=None,
                         connect_timeout=None, request_timeout=None, max_timeout_tries=None,
                         speculative_timeout_pct=None, waited=True, parse_response=True, parse_on_error=True,
                         fail_fast=False) -> RequestResult:
    ...
    async def _execute_http_client_method(self, host, uri, client_method, waited) -> RequestResult:
        ...
        if not waited:
            asyncio.create_task(client_method())
            return None
