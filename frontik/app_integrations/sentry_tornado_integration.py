...
class TornadoIntegration(Integration):
    ...
    def setup_once():
        ...
        old_execute = PageHandler.execute
        ...
        PageHandler.execute = sentry_execute_request_handler

        old_log_exception = PageHandler.log_exception
        ...
        PageHandler.log_exception = sentry_log_exception


@contextlib.contextmanager
def _handle_request_impl(self):
    # type: (PageHandler) -> Generator[None, None, None]
    ...
    with sentry_sdk.isolation_scope() as scope:
        ...
        with sentry_sdk.start_transaction(transaction, custom_sampling_context={'tornado_request': self.request}):
            yield
...
def _make_event_processor(weak_handler):
    # type: (Callable[[], PageHandler]) -> EventProcessor
