...
class UpstreamCachesTestCase(unittest.TestCase):
    ...
    def test_update_upstreams_servers_different_dc(self):
        ...
        upstream_cache._update_upstreams_service('test', 'app', value_one_dc)
        upstream_cache._update_upstreams_service('another', 'app', value_another_dc)
    ...
    def test_remove_upstreams_servers_different_dc(self):
        ...
        upstream_cache = UpstreamCaches({}, {})
        upstream_cache._update_upstreams_service('test', 'app', value_test_dc)
        upstream_cache._update_upstreams_service('another', 'app', value_another_dc)
        ...
        upstream_cache._update_upstreams_service('another', 'app', value_another_remove_service_dc)
