...
class Page(AwaitablePageHandler):
    async def get_page(self):
        self.application.http_client_factory.update_upstream(Upstream('retry_error_async', {},
        ...
        check_all_servers_occupied(self, 'retry_error_async')

        await asyncio.gather(request1, request2, request3)

        check_all_requests_done(self, 'retry_error_async')
