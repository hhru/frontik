...
class TestSyslog(FrontikTestBase):
    ...
    async def test_send_to_syslog(self):
        ...
        expected_service_logs = [
            {
                'priority': '14',
                'message': {'lvl': 'INFO', 'logger': r'handler', 'msg': 'requested url: /log', 'appender': 'service'},
            },
            {
                'priority': '15',
                'message': {'lvl': 'DEBUG', 'logger': r'handler', 'msg': 'debug', 'appender': 'service'},
            },
            {'priority': '14', 'message': {'lvl': 'INFO', 'logger': r'handler', 'msg': 'info', 'appender': 'service'}},
            {
                'priority': '11',
                'message': {
                    'lvl': 'ERROR',
            ...
            {
                'priority': '10',
                'message': {'lvl': 'CRITICAL', 'logger': r'handler', 'msg': 'critical', 'appender': 'service'},
            },
        ]
...
class TestLogToFile(FrontikTestBase):
    ...
    def setup_class(cls):
        ...
        options.log_json_with_appender_name = True
